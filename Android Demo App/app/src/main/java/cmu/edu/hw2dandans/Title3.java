...
public class Title3 extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        result = readEvents();
        String[] from = new String[] { SQLiteHelper.COLUMN_name, SQLiteHelper.COLUMN_dateTime, SQLiteHelper.COLUMN_location};
        int[] to = new int[] {R.id.eventName, R.id.eventDateTime, R.id.eventLocation};
        eventAdapter = new SimpleCursorAdapter(getContext(), R.layout.item_event,
                result, from, to, 0);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_title3, container, false); // Set the adapter
    ...
    private Cursor readEvents() {
        EventDAO eventDao = new EventDAO(getContext()); result = eventDao.getAllEvents();
        return result;
    }
}
