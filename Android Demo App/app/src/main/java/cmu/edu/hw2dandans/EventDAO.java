...
public class EventDAO {
    ...
    public Cursor getAllEventNames() {
        ...
        return database.query(SQLiteHelper.TABLE_Event, new String[] {"_id", "name"},
                null, null, null, null, "_id");
    }

    public Cursor getAllEvents() {
        database = dbHelper.getReadableDatabase();
        return database.query(SQLiteHelper.TABLE_Event, new String[] {"_id", "name", "dateTime",
    ...
    public Cursor getOneEvent(long id) {
        database = dbHelper.getReadableDatabase();
        return database.query(SQLiteHelper.TABLE_Event, null, "_id=" + id,
                null, null, null, null);
    }
